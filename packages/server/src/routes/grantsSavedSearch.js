...
router.post('/', requireUser, async (req, res) => {
    ...
    try {
        ...
        console.error(e);
        res.status(500).send('Unable to create saved search. Please reach out to grantsreporting.helpdesk@navapbc.com');
    }
});
...
router.put('/:searchId', requireUser, async (req, res) => {
    ...
    try {
        ...
        console.error(e);
        res.status(500).send('Unable to update saved search. Please reach out to grantsreporting.helpdesk@navapbc.com');
    }
});
